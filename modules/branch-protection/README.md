...
hand (repo Settings → Branches). When the guard fails, the CI plan job prints the
repo's full classic settings so they can be compared against the ruleset first — see
