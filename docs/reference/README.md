...
*Information-oriented* documentation — descriptive, not procedural (following the [Divio/Diátaxis](https://diataxis.fr/) split). If a doc has no steps to follow and exists to be looked up, it belongs here, not in [`../runbooks/`](../runbooks/). Referenced indefinitely; no checkboxes.
...
| [`github-plan.md`](github-plan.md) | The owner's GitHub plan and account type, and what depends on each — Pro gates rulesets on private repositories; merge queue is gated on organisation ownership, not plan — plus why the plan is documented rather than asserted in Terraform |
