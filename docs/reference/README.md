...
*Information-oriented* documentation — descriptive, not procedural (following the [Divio/Diátaxis](https://diataxis.fr/) split).
If a doc has no steps to follow and exists to be looked up, it belongs here, not in [`../runbooks/`](../runbooks/).
Referenced indefinitely; no checkboxes.
